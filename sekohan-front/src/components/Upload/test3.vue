...
export default {
  ...
  methods: {
    ...
    priceselectlow() {
      this.pro_image.sort((a, b) => a.proPrice - b.proPrice);
    },
    priceselecthigh() {
      this.pro_image.sort((a, b) => b.proPrice - a.proPrice);
    },
    timeslectnew() {
      this.pro_image.sort((a, b) => a.productId - b.productId);
    },
    timeselectold() {
      this.pro_image.sort((a, b) => b.productId - a.productId);
    },
    onItemSelect() {
      console.log();
    ...
    imageData() {
      ...
      let URL = `http://localhost:7070/products/pagelist?page=${this.page-1}`

      if (pageid > 1) {
        URL = `http://localhost:7070/products/pagelist/${pageid}?page=${this.page-1}`;
      }
