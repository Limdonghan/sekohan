<template>
    ...
    <v-row>
      <v-col cols="12" sm="4" >
      <v-img   min-height="180" 
      max-height="180" style="margin-top:10px;" :src="src" ></v-img>
    </v-col>
    <v-col cols="12" sm="5">
    ...
    <v-col cols="12" sm="3" style="align=right;">
              <v-btn  size="small" color="blue" style="margin-top:100px; min-width: 100px;  ">찜 목록 빼기</v-btn>
              <p></p>
              <v-btn :href="url" size="small" color="blue" style="margin-top:10px; min-width: 100px;"><v-icon>mdi-information</v-icon>상세 정보</v-btn>
          </v-col>
    </v-row>
    </v-card>
        </v-col>
